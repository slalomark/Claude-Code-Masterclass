...
description: Firestore type conventions and patterns for TypeScript projects. Use when: (1) Creating new Firestore document types, (2) Defining collection schemas, (3) Impelementing serialization/converters, (4) Setting up type-safe Firestore queries, or (5) Working with Firestore timestamps and type patters.
---
